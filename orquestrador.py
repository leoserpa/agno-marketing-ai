...
orquestrador = Team(
    ...
    instructions=[
        ...
        "Neste caso, RECUSE educadamente copiando e colando APENAS esta frase exata: 'Para garantir a máxima qualidade e não exceder o limite de processamento da IA, por favor, peça um formato de cada vez. Você prefere que eu comece pelo Artigo, pelas Legendas do Instagram ou pelo Email?'",
